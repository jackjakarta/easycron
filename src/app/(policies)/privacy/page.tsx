        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <div className="text-foreground space-y-8">
            <TypographyP>
              ...
              uses, and protects personal data when you use our web application ("
              <strong>the Service</strong>"). Our Service allows users to schedule and manage
              automated HTTP requests ("cron jobs").
            </TypographyP>
            ...
            <section>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div>
                  ...
                  <TypographyList>
                    <li>
                      Actions performed within the Service (e.g., job creation, editing, or
                      deletion)
                    </li>
                    <li>
                      Metadata about your cron jobs (schedule times, target URLs, headers, etc.)
                    </li>
                ...
                <div>
                  ...
                  <TypographyP>
                    ...
                    stored in <strong>Supabase Storage (S3-compatible)</strong>, hosted within the
                    EU.
                  </TypographyP>
                </div>
              </div>
            ...
            <section>
              ...
              <TypographyP>
                We <strong>do not sell</strong>, rent, or share your personal data with third
            ...
            <section>
              ...
              <TypographyList>
                <li>
                  <strong>Contractual necessity</strong> (Art. 6(1)(b) GDPR): to provide the Service
                  you signed up for.
                </li>
                <li>
            ...
            <section>
              ...
              <TypographyList className="text-foreground mt-4 space-y-2">
                ...
                <li>
                  For a reasonable period thereafter, as required by law (e.g., billing records for
                  10 years under German law).
                </li>
              </TypographyList>
              <TypographyP>
            ...
            <section>
              ...
              <TypographyP>
                We use the following trusted service providers (processors):
              </TypographyP>
              ...
              <TypographyP>
                All third-party services are bound by data processing agreements (DPAs) and comply
                with GDPR and, where applicable, EU Standard Contractual Clauses (SCCs).
              </TypographyP>
            </section>
            ...
            <section>
              ...
              <TypographyP>
                ...
                particularly when using global service providers (e.g., Stripe, Google). Such
            ...
            <section>
              ...
              <TypographyP>
                However, no online system is 100% secure, and we cannot guarantee absolute
                protection.
              </TypographyP>
            </section>
            ...
            <section>
              ...
              <TypographyP>
                ...
                <strong>not</strong> use third-party advertising or tracking cookies. Optional
                analytics (if enabled) will be anonymized and compliant with GDPR.
              </TypographyP>
            </section>
