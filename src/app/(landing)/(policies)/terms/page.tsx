    ...
    <>
      ...
      <div className="text-foreground space-y-8">
        <TypographyP>
          ...
          of the web application and related services (the &quot;<strong>Service</strong>
          &quot;) operated by <strong>Easy Services GmbH</strong> (&quot;<strong>we</strong>
          &quot;, &quot;
          <strong>us</strong>&quot;, or &quot;<strong>our</strong>&quot;). By using the Service, you
        ...
        <section>
          ...
          <TypographyP>
            The Service operates on a <strong>subscription basis</strong>, billed monthly or yearly
          ...
          <div className="mt-6 space-y-6">
            ...
            <div>
              ...
              <TypographyP>
                You can cancel anytime via your account dashboard. Access will continue until the
                end of the current billing period. No partial refunds are provided for unused time.
              </TypographyP>
            </div>
        ...
        <section>
          ...
          <TypographyP>
            You retain ownership of the content and configurations you create. By using the Service,
            you grant us a limited license to process, store, and transmit your data as necessary to
            operate the Service.
          </TypographyP>
        </section>
        ...
        <section>
          ...
          <TypographyP>
            ...
            branding, are owned by <strong>Easy Services GmbH</strong> or its licensors. You may not
        ...
        <section>
          ...
          <TypographyList className="text-foreground mt-4 space-y-2">
            <li>
              ...
              including lost profits, data loss, or downtime.
            </li>
            <li>
              Our total liability for any claim related to the Service is limited to the amount paid
              by you in the <strong>past 12 months</strong>.
            </li>
          </TypographyList>
          <TypographyP>
        ...
        <section>
          ...
          <TypographyP>
            We may update these Terms or modify the Service at any time. If changes are material, we
            will notify you in advance via email or in-app notice. Continued use after the effective
        ...
        <section>
          ...
          <TypographyP>
            ...
            , constitute the entire agreement between you and <strong>Easy Services GmbH</strong>{' '}
