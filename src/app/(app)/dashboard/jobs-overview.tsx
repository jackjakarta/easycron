        ...
        <div className="mb-6 flex gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">
              <span className="font-semibold">{activeJobs.length}</span> Active
            </span>
          </div>
          <div className="flex items-center gap-2">
            <div className="h-3 w-3 rounded-full bg-gray-400" />
            <span className="text-sm">
              <span className="font-semibold">{pausedJobs.length}</span> Paused
            </span>
          </div>
          <div className="flex items-center gap-2">
            <div className="h-3 w-3 rounded-full bg-red-500" />
            <span className="text-sm">
              <span className="font-semibold">{errorJobs.length}</span> Error
            </span>
          </div>
        </div>
              ...
              >
                <div className="flex flex-1 items-center gap-3">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-muted-foreground text-xs">{job.schedule}</p>
                  </div>
                </div>
