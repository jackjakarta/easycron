...
ALTER TABLE "app"."job" ADD COLUMN "organization_id" uuid NOT NULL;--> statement-breakpoint
...
ALTER TABLE "app"."member" ADD CONSTRAINT "member_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "app"."organization"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "jobs_project_id_org_id_idx" ON "app"."job" USING btree ("project_id","organization_id");--> statement-breakpoint
